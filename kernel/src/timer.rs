...
use crate::{interrupt, memory_manager::LazyInit, EVENTS};
...
impl TimerManager {
    ...
    pub fn tick(&mut self) {
        unsafe {
            ...
            write_volatile(&mut self.tick as *mut u64, t+1);
        }
...
fn initialize_lapic_timer() {
    unsafe {
        ...
        write_volatile(INITIAL_COUNT_ADDR, 100000000);
    }
}
